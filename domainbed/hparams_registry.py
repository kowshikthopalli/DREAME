...
def _hparams(algorithm, dataset, random_seed):
    ...
    elif algorithm == "DREAME":
        _hparam('DREAME_beta',1.,lambda r: 10**r.uniform(-1, 1))
    ...
    if algorithm in ['DREAME']:
        _hparam('DREAME_num_models',3, lambda r: r.randint(3,size=1))
    if algorithm in ['DREAME']:    
        _hparam('lr_DREAME', 5e-5, lambda r: 10**r.uniform(-5, -3.5))
    if algorithm in ['DREAME']:    

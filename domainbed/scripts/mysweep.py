...
def make_args_list(n_trials, dataset_names, algorithms, n_hparams_from, n_hparams, steps,
    data_dir, task, holdout_fraction, single_test_envs,use_user_defined_test_env,user_defined_test_env, hparams):
    args_list = []
    for trial_seed in range(n_trials):
        for dataset in dataset_names:
            for algorithm in algorithms:
                ...
                elif user_defined_test_env:
                    all_test_envs = [user_defined_test_env]
                else:
...
if __name__ == "__main__":
    ...
    args_list = make_args_list(
        ...
        use_user_defined_test_env=args.use_user_defined_test_env,
        user_defined_test_env= args.user_defined_test_env,

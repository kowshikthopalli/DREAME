...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="DREAME_PACS_aug_debug")
    ...
    for step in range(start_step, n_steps):
        ...
        if (step % checkpoint_freq == 0) or (step == n_steps - 1):
            ...
            if args.algorithm == 'DREAME': 
                ...
                results_DREAME = misc_aug.DREAME_accuracy(algorithm, eval_dict, args.test_envs, correct_models_selected_for_each_domain,device,acc_flags)#compute_test_beta=compute_test_beta)
